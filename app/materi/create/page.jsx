...
import { createMateriAPI, checkToken } from "../../../server/api";
import "./style.css";
...
const MateriCreate = () => {
  ...
  const handleDescreiptionChange = (event) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      alert("An error occurred while creating the Materi.");
    }
  };
  ...
  return (
    <>
      <title>Mathlearn - Buat Materi Matematika</title>
      ...
      <div>
        ...
        <div className="flex flex-row">
          ...
          <div className="flex flex-col w-full">
            ...
            >
              <div className="relative my-50 pb-2 transform w-[90%] border-solid border-4 border-orange-400 rounded-xl bg-gray-100">
                <div className="flex items-center p-3">
                  <div className="flex flex-1 gap-3">
                    <a
                      href="#"
                      className="bg-white rounded-md p-2 w-[12%]"
                      onClick={goBack}
                    >
                      &lt; Kembali
                    </a>
                    ...
                    <input
                      type="text"
                      className="border border-gray-300 rounded-md p-2 w-[54%]"
                      placeholder="Deskripsi . . ."
                      value={description}
                      onChange={handleDescreiptionChange}
                    />
                  </div>
