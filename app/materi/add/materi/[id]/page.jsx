...
import { addSectionMaterial } from "../../../../../server/api";
import "./style.css";
...
const MateriAdd = ({ params }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      setLoading(true);
      await addSectionMaterial(data, params.id);
      setTimeout(() => {
        window.location.href = `/materi/${params.id}`;
      }, 5000);
    } catch (error) {
  ...
  return (
    <>
      <title>Mathlearn - Tambah Materi Matematika</title>
